...
def display_welcome(images):
    ...
    with col1:
        if "dna_logo" in images and images["dna_logo"] is not None:
            st.image(images["dna_logo"], width=120)
    ...
    # Display genetic diseases image prominently near the title
    ...
    with col2:
        if "system_diagram" in images and images["system_diagram"] is not None:
            st.image(images["system_diagram"], caption="AI-Powered Genomic Analysis System")
    
    # Display CRISPR technology image
